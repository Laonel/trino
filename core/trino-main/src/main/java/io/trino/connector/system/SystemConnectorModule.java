        ...
        implements Module
{
    ...
    public void configure(Binder binder)
    {
        ...
        binder.bind(TableFunctionManager.class).to(SystemTableFunctionManager.class).in(Scopes.SINGLETON);
        Multibinder.newSetBinder(binder, TableFunctionProvider.class);
